...
require_once(__DIR__ . '/../../boost_union/layout/includes/courseindex.php');
...
require_once(__DIR__ . '/../../boost_union/layout/includes/courserelatedhints.php');

// Include the template content for the block regions.
require_once(__DIR__ . '/../../boost_union/layout/includes/blockregions.php');

// Include the content for the back to top button.
require_once(__DIR__ . '/../../boost_union/layout/includes/backtotopbutton.php');

// Include the content for the scrollspy.
require_once(__DIR__ . '/../../boost_union/layout/includes/scrollspy.php');

// Include the template content for the footnote.
require_once(__DIR__ . '/../../boost_union/layout/includes/footnote.php');

// Include the template content for the static pages.
require_once(__DIR__ . '/../../boost_union/layout/includes/staticpages.php');

// Include the template content for the footer button.
require_once(__DIR__ . '/../../boost_union/layout/includes/footer.php');

// Include the template content for the JavaScript disabled hint.
require_once(__DIR__ . '/../../boost_union/layout/includes/javascriptdisabledhint.php');
...
if ($PAGE->pagelayout == 'frontpage') {
    require_once(__DIR__ . '/../../boost_union/layout/includes/advertisementtiles.php');
}

// Include the template content for the slider, but only if we are on the frontpage.
if ($PAGE->pagelayout == 'frontpage') {
    require_once(__DIR__ . '/../../boost_union/layout/includes/slider.php');
}
